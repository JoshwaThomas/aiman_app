...
const ProductServices = {
  ...
  getAllProducts: async (body) => {
    return requests.get("/products/allproducts", {ProductData: body})
  },

  getCategoryID: async (categoryID) => {
    console.log(`Trigger getcategory/${categoryID} the async func.`)
    return requests.get(`/products/getcategory/${categoryID}`)
  },
