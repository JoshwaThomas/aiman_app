...
const Dashboard = () => {
  ...
  const fetchApplication = async () => {
    try {
      const res = await AdminServices.getMyApplication();
      setApp(res.data);
    } catch (err) {
      console.error(err);
    }
    ...
    <div className="p-6">
      ...
      /* ================= STUDENT DASHBOARD ================= */
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <h2 className="text-lg font-bold">Apply for Admission</h2>
            <p className="text-sm mt-2 text-gray-600">
              Fill your application form step by step
            </p>
          </Card>
          ...
          <Card className="p-6">
            ...
            {app ? (
              <div className="mt-3">
                ...
                <button
                  onClick={() =>
                    history.push(`/application-preview/${app._id}`)
                  }
