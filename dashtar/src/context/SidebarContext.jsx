...
export const SidebarProvider = ({ children }) => {
  ...
  const toggleDrawer = () => {
    console.log("Toggling drawer state");
  ...
  //pay recipet
  const [previewPayData, setPreviewPayData] = useState(null);
  const [isPreviewPayOpen, setIsPreviewPayOpen] = useState(false);

  const openPayPreview = (data) => {
    setPreviewPayData(data);
    setIsPreviewPayOpen(true);
  };

  const closePayPreview = () => {
    setPreviewPayData(null);
    setIsPreviewPayOpen(false);
  };
