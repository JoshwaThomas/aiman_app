...
const useInvoiceSubmit = (id) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            console.log("Invoice Data", QuotationData);

            const res = id
                ? await AdminServices.updateInvoice(id, QuotationData)
                : await AdminServices.addInvoice(QuotationData);
            console.log('res', res)
