...
function UGApplication() {
  ...
  const [activeFilters, setActiveFilters] = useState({gradType: "UG", pref: "", status: "", paidStatus: ""});
  ...
  const handleShow = () => {
    ...
    setActiveFilters({gradType: "UG", pref: selectedPref, status: selectedStatus, paidStatus: selectedPaidStatus});
  ...
  const handleReset = () => {
    ...
    setPage(1);
    setActiveFilters({gradType: "UG", pref: "", status: "", paidStatus: ""});
  };
          ...
          <Card className="min-w-0 shadow-xs overflow-hidden border border-slate-300 bg-white dark:bg-gray-800 mb-5">
            <CardBody>
              <div className="flex items-end gap-4 flex-wrap">
                ...
                {/* Grade Type */}
                {/* <div className="flex flex-col hidden gap-1">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select value={selectedStatus} onChange={(e) => setSeletedStatus(e.target.value)}
                    className="border rounded px-2 py-1.5 disabled:opacity-50">
                    <option value="">All</option>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select value={selectedPaidStatus} onChange={(e) => setSelectedPaidStatus(e.target.value)}
                    className="border rounded px-2 py-1.5 disabled:opacity-50">
                    <option value="">All</option>
            ...
            {loading ? (
              ...
              tableData.map((item, index) => (
                <TableRow key={item._id}>
                  ...
                  <TableCell>
                    <span onClick={() => {setIsActionModalOpen(true), setSelectedAppId(item._id)}}
                      className="p-2 text-black font-bold text-2xl cursor-pointer">
                      ⋮
                    </span>
                  </TableCell>
                </TableRow>
